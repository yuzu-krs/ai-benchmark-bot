import type { ReleaseStage } from "../types.js";
...
export type AnnouncementConfidence = "confirmed" | "candidate";
...
export interface AnnouncementItem {
  ...
  modelIds: string[];
  stage: ReleaseStage;
  confidence: AnnouncementConfidence;
...
export function buildAnnouncementItems(
  ...
  for (const raw of rawItems) {
    ...
    const itemKey = `${sourceId}:${raw.key}`;
